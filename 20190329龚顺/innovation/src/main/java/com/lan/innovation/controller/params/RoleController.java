...
import static com.lan.common.utils.DtfpUtils.jsonArrToOrclInStr;
...
public class RoleController {
    ...
    public List<Long> getRolePermission(RoleVo roleVo){
        ...
        String sql = " SELECT srp.* FROM sys_role_permission srp INNER JOIN sys_role_permission srp ON sp.id = srp.sys_permission_id where sys_role_id = '"+ roleVo.getId() +"' AND percode = 2 ";
