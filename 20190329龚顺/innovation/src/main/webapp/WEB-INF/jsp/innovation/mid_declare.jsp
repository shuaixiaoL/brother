...
<head>
    ...
    <link type="text/css" href="${path}/static/css/jsp/mid_declare.css"/>
</head>
<body>
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <template>
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column prop="funds" label="经费"></el-table-column>
                    ...
                    <el-table-column label="操作" width = "180px">
                        <template slot-scope="scope">
                            ...
                            <el-button size="mini" @click="handleDelete(scope.$index, scope.row)">提交</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </template>
    ...
    <template>
        <el-dialog title="" :visible.sync="dialogVisible" class="customClass" top="true" width="80%" center>
            ...
            <el-form ref="tableFormRow" label-width="80px" v-model="tableDataRow" size="mini">
                ...
                <el-form-item label="项目描述">
                    <el-col :span="12">
                        <el-input type="textarea" v-model="tableDataRow.descInfo">{{tableDataRow.descInfo}}</el-input>
                    </el-col>
                </el-form-item>
                <el-form-item label="组长" v-if="tableDataRow.compareRealName != null">
                    {{tableDataRow.compareRealName}}
...
<script type="text/javascript" src="${path}/static/js/jsp/mid_declare.js"></script>
</body>
</html>
