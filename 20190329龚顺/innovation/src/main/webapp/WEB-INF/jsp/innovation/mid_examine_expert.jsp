...
<head>
    ...
    <link type="text/css" href="${path}/static/css/jsp/mid_examine_expert.css"/>
</head>
<body>
    ...
    <template>
        <el-dialog  title="" :visible.sync="outerVisible" class = "customClass"  top = "true" width = "80%"  center>
            <div slot="title" class="dialog-header">
                显示详细
                <el-button v-if = "tableDataRow.applyStatus == 2 || tableDataRow.applyStatus == 6 " type="primary"  size="mini" @click="passExamine" style="float: right;margin-right: 35px;margin-top: -5px;">通过</el-button>
            </div>
...
<script type="text/javascript" src="${path}/static/js/jsp/mid_examine_expert.js"></script>
</body>
</html>
