...
<head>
    ...
    <link type="text/css" href="${path}/static/css/jsp/res_examine_expert.css"/>
</head>
<body>
...
<div id="app">
                ...
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column label="操作"  width = "180px">
                        <template slot-scope="scope">
                            ...
                            <el-button
                                    v-if="scope.row.applyStatus == '2' ||scope.row.applyStatus == '3' ||  scope.row.applyStatus == '6'"
                                    size="mini"
                                    type="danger"
    ...
    <el-dialog
            ...
            width="30%"
            :before-close="handleClose">
        <el-input v-model="work" placeholder="请输入内容"></el-input>
        <span slot="footer" class="dialog-footer">
            <el-button @click="passDialogVisible = false">取 消</el-button>
            <el-button type="primary" @click="workExamine">确 定</el-button>
        </span>
    </el-dialog>
</div>

<jsp:include page="../vuetemplate/js_vue_template.jsp" flush="true"></jsp:include>
<script type="text/javascript" src="${path}/static/js/jsp/res_examine_expert.js"></script>
</body>
</html>
