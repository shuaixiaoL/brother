...
<head>
    ...
    <link type="text/css" href="${path}/static/css/jsp/title_declare.css"/>
</head>
<body>
                ...
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            ...
                            <el-button v-if ="scope.row.applyStatus == 1 || scope.row.applyStatus == 5 || tableDataRow.applyStatus == 6" size="mini" @click="handleDelete(scope.$index, scope.row)">提交</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </template>
    ...
    <template>
        <el-dialog title="" :visible.sync="dialogVisible" class="customClass" top="true" width="80%" center>
            ...
            <el-form ref="tableFormRow" label-width="80px" v-model="tableDataRow" size="mini">
                ...
                <el-form-item label="项目描述">
                    <el-col :span="12">
                        <el-input type="textarea" v-model="tableDataRow.descInfo"></el-input>
                    </el-col>
                </el-form-item>
                <el-form-item label="组长" v-if="tableDataRow.compareRealName != null">
                    {{tableDataRow.compareRealName}}
...
<script type="text/javascript" src="${path}/static/js/jsp/title_declare.js"></script>
</body>
</html>
