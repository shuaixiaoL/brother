...
<head>
    ...
    <link type="text/css" href="${path}/static/css/jsp/title_declare_teacher.css"/>
</head>
<body>
    ...
    <el-row :gutter="10">
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <el-form ref="titleForm" :model="titleForm" :rules="rules" label-width="120px" size="mini">
                <el-form-item>
                    <el-col :span="24"><div class="title-content" style="font-size: 30px;font-family: '宋体';">教师题目申报</div></el-col>
                </el-form-item>
                ...
                <el-form-item label="指导老师工号" prop="teacherNum">
                    <el-col :span="12">
                        <el-input v-model="titleForm.teacherNum" @blur="checkTeacherNum('titleForm_teacherNum')"></el-input>
                    </el-col>
...
<script type="text/javascript" src="${path}/static/js/jsp/title_declare_teacher.js"></script>
</body>
</html>
