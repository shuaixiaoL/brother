...
<head>
    ...
    <link type="text/css" href="${path}/static/css/jsp/title_examine_expert.css"/>
</head>
<body>
...
<div id="app">
                ...
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            ...
                            <el-button
                                    v-if="scope.row.applyStatus == '2' || scope.row.applyStatus == '6' || scope.row.applyStatus == '3'"
                                    size="mini"
                                    type="danger"
    ...
    <template>
        <el-dialog  title="" :visible.sync="outerVisible" class = "customClass"  top = "true" width = "80%"  center>
            <div slot="title" class="dialog-header">
                显示详细
                <el-button v-if = "tableDataRow.applyStatus == 2 || tableDataRow.applyStatus == 6 " type="primary"  size="mini" @click="openPassExmine" style="float: right;margin-right: 35px;margin-top: -5px;">通过</el-button>
            </div>
    ...
    <el-dialog
            ...
            width="30%"
            :before-close="handleClose">
        <el-input v-model="funds" placeholder="请输入内容"></el-input>
        <span slot="footer" class="dialog-footer">
            <el-button @click="passDialogVisible = false">取 消</el-button>
            <el-button type="primary" @click="fundsConfirm">确 定</el-button>
        </span>
    </el-dialog>
</div>

<jsp:include page="../vuetemplate/js_vue_template.jsp" flush="true"></jsp:include>
<script type="text/javascript" src="${path}/static/js/jsp/title_examine_expert.js"></script>
</body>
</html>
