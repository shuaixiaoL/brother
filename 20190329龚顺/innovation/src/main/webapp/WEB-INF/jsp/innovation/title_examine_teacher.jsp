...
<head>
    ...
    <link type="text/css" href="${path}/static/css/jsp/title_examine_teacher.css"/>
</head>
<body>
...
<script type="text/javascript" src="${path}/static/js/jsp/title_examine_teacher.js"></script>
</body>
</html>
