...
<head>
    ...
    <link type="text/css" href="${path}/static/css/jsp/work_declare.css"/>
</head>
<body>
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <template>
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column :formatter="dateFormatter" prop="sqTime" label="申请时间"></el-table-column>
                    ...
                    <el-table-column prop="work" label="工作量"></el-table-column>
    ...
    <template>
        <el-dialog title="" :visible.sync="outerVisible" class="customClass" top="true" width="80%" center>
            ...
            <el-form ref="tableFormRow" label-width="80px" v-model="tableDataRow" size="mini">
                ...
                <el-form-item label="工作量" v-if="tableDataRow.work != null">
                    {{tableDataRow.work}}
                </el-form-item>
            </el-form>
...
<script type="text/javascript" src="${path}/static/js/jsp/work_declare.js"></script>
</body>
</html>
