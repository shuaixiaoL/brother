...
<head>
    ...
    <link type="text/css" href="${path}/static/css/jsp/work_examine_expert.css"/>
</head>
<body>
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            <template>
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column prop="sqTime" label="申请时间"></el-table-column>
                    ...
                    <el-table-column label="操作">
                        <template slot-scope="scope">
                            ...
                            <el-button
                                    v-if="scope.row.applyStatus == '1' || scope.row.applyStatus == '6'"
                                    size="mini"
                                    type="danger"
    ...
    <template>
        <el-dialog  title="" :visible.sync="outerVisible" class = "customClass"  top = "true" width = "80%"  center>
            <div slot="title" class="dialog-header">
                显示详细
                <el-button v-if = "tableDataRow.applyStatus == 1 || tableDataRow.applyStatus == 6 " type="primary"  size="mini" @click="passExamine" style="float: right;margin-right: 35px;margin-top: -5px;">通过</el-button>
            </div>
...
<script type="text/javascript" src="${path}/static/js/jsp/work_examine_expert.js"></script>
</body>
</html>
