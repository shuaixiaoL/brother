    ...
    <template>
        <el-dialog title="" :visible.sync="dialogVisible" class="customClass" top="true" width="80%" center>
            ...
            <el-form ref="rowForm" label-width="80px" v-model="rowForm" size="mini">
                ...
                <el-form-item label="分类：">
                    <el-select v-model="rowForm.messageStatus" clearable  placeholder="全部" @change="updateMessageStatus">
                        <el-option v-for="(item,index) in fw_dim.LY" :label="item.text" :value="item.value"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item>
    ...
    var vue = new Vue({
        ...
        methods: {
            ...
            deleteBatchMessage: function () {
                ...
                axios.post(
                    contextPath + '/rest/api/messageCheck/deleteBatchMessage', {
            ...
            deleteMessage: function (id) {
                let self = this;
                axios.get(
                    contextPath + '/rest/api/messageCheck/deleteMessage/' + id)
                    .then(function (response) {
                        const data = response.data;
                        if (data.result == '0000') {
                            self.$message(data.msg);
            ...
            updateMessageStatus: function () {
                let self = this;
                axios.post(
                    contextPath + '/rest/api/messageCheck/updateMessageStatus',
                    self.rowForm
                )
                    .then(function (response) {
                        const data = response.data;
            ...
            queryMessage: function () {
                let self = this;
                axios.get(
                    contextPath + '/rest/api/messageCheck/queryMessage',
                    {
                        params:{
