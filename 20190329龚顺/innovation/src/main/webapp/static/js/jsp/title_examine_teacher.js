...
var vue = new Vue({
    ...
    methods: {
        ...
        rejectConfirm() {
            ...
            axios.put(this.pageContentUrl.rejectConfirmUrl, jsjson)
        ...
        passExamine() {
            ...
            axios.put(this.pageContentUrl.passConfirmUrl, jsjson)
                .then(function (response) {
                    console.log(response);//成功后调用
                    if (response.data.result == '0000') {
                        this.$message(response.data.msg);
                        this.selectProjectUser();//重新访问
                    } else if (response.data.result == '9999') {
                        this.$message(response.data.msg);
                    }
                }.bind(this))
